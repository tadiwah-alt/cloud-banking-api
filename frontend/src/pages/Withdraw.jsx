...
import { BuffaloCrest } from "../theme/icons";
...
export default function Withdraw() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: `Withdrew $${result.withdrawn.toFixed(2)}. New balance: $${result.new_balance.toFixed(2)}.`,
      });
      setAmount("");
    } catch (err) {
      const errText = err.response?.data?.error || "Withdrawal failed. Try again.";
